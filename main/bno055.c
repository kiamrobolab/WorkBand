...
esp_err_t bno055_set_default_conf(bno055_config_t * p_bno_conf){
    ...
    p_bno_conf->sda_pullup_en = GPIO_PULLUP_ENABLE; //GPIO_PULLUP_DISABLE;  // Internal GPIO pull mode for I2C sda signal
    p_bno_conf->scl_io_num = 19;        // GPIO number for I2C scl signal 26 
    p_bno_conf->scl_pullup_en = GPIO_PULLUP_ENABLE; //GPIO_PULLUP_DISABLE;  // Internal GPIO pull mode for I2C scl signal
